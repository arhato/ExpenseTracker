...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final PinLibraryAccessors laccForPinLibraryAccessors = new PinLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>pin</b>
     */
    public PinLibraryAccessors getPin() {
        return laccForPinLibraryAccessors;
    }
    ...
    public static class GmsPlayServicesLocationLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v2110</b> with <b>com.google.android.gms:play-services-location</b> coordinates and
         * with version reference <b>googlePlayServicesLocation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV2110() {
            return create("gms.play.services.location.v2110");
        }
    ...
    public static class MaterialIconsLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>extended</b> with <b>com.google.android.material:material-icons-extended</b> coordinates and
    ...
    public static class PinLibraryAccessors extends SubDependencyFactory {
        private final PinLockLibraryAccessors laccForPinLockLibraryAccessors = new PinLockLibraryAccessors(owner);

        public PinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>pin.lock</b>
         */
        public PinLockLibraryAccessors getLock() {
            return laccForPinLockLibraryAccessors;
        }

    }

    public static class PinLockLibraryAccessors extends SubDependencyFactory {

        public PinLockLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compose</b> with <b>com.github.raheemadamboev:pin-lock-compose</b> coordinates and
         * with version reference <b>pinLockComposeVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("pin.lock.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>biometric</b> with value <b>1.4.0-alpha02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googlePlayServicesLocation</b> with value <b>21.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>materialIconsExtended</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>pinLockCompose</b> with value <b><current_version></b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPinLockCompose() { return getVersion("pinLockCompose"); }

        /**
         * Version alias <b>pinLockComposeVersion</b> with value <b>1.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPinLockComposeVersion() { return getVersion("pinLockComposeVersion"); }
